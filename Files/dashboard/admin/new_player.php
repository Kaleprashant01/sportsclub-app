...
$query="insert into players(name,gender,mobile ,email,dob ) values('$uname','$gender','$phn','$email','$dob')";
    if(mysqli_query($con,$query)==1){
      ...
      $result=mysqli_query($con,$query1);
        ...
        if($result){
          ...
          $query2="insert into enrolls(pid,uid,paid_date,expire,renewal) values('$plan','$memID','$cdate','$expiredate','yes')";
          if(mysqli_query($con,$query2)==1){

            $query4="insert into healthstatus(uid) values('$memID')";
        ...
        else
        {
          ...
          $query3 = "DELETE FROM users_detail WHERE userid='$memID'";
          mysqli_query($con,$query3);
        }
