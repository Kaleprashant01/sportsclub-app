...
if(isset($_POST['submit'])){
  ...
  $query="update admin set username='".$usrname."',username='".$fulname."' where username='".$_SESSION['username']."'";
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
           	 <tr>
           	   <td height="35">ID:</td>
           	   <td height="35"><input type="text" name="login_id" value="<?php echo $_SESSION['id']; ?>" class="form-control" required/></td>
         	   </tr>
             <tr>
               <td height="35">FULL NAME:</td>
               <td height="35"><input class="form-control" type="text" name="full_name" id="textfield2" value="<?php echo $_SESSION['username']; ?>"required></td>
             </tr>
             <tr>
